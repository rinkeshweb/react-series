...
export default function Card() {
    return (
        <div className="w-full rounded-lg shadow border bg-white text-gray-900 border-gray-200 dark:!bg-gray-800 dark:!border-gray-700 dark:!text-white transition-colors">
            <a href="/">
